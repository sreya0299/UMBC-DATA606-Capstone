...
# Load TF-IDF model
tfidf = pickle.load(open('notebooks/tfidf.pkl', 'rb'))
...
selected_models = st.sidebar.multiselect("Select Models:", list(models.keys()), default=[], help="Select one or more models from the list")
